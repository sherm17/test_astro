...
default_args={
    "owner": "pengsherman@gmail.com,Open in Cloud IDE",
}

@dag(
    default_args=default_args,
    schedule=None,
    start_date=pendulum.from_format("2024-11-22", "YYYY-MM-DD"),
    catchup=False,
    owner_links={
        "pengsherman@gmail.com": "mailto:pengsherman@gmail.com",
        "Open in Cloud IDE": "https://cloud.astronomer.io/cm3tbeepm0s9h01qbotrd5azk/cloud-ide/cm3tbm1ze0ris01npt4zp9ng4/cm3tbm28q0sao01qbtgtpzvvh",
    },
)
